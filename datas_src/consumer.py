...
#     from rds import RDS
#
#     # TOPIC = "HKEX-F-HSI-1912"
#     # HOSTS = "192.168.1.152:9092,192.168.1.163:9092"
#     # GROUP = "HKEX-F-HSI-1912"
#     # CNID = "HKEX-F-HSI-1912"
#     # subs = subscribe("HKEX-F-HSI-1915")
#     # for msg in subs:
#     #     print(msg)
#
#     # 检查当前路径
...
#     # GROUP = "total"
#     # CNID = "1"
#     # lds = create_consumer(HOSTS, TOPIC, GROUP, CNID, pack=None, simple=False)
#     # for msg in lds:
#     #     # print(msg)
#     #     data = msg.value
#     #     content = spliter(data)
#     #     print(content.ts)
#     # from .tpmanager import retrieve_topics
